...
export const scriptParameters: ReadonlyArray<Core.GOConfigParameterOptions> = [
  ...
  {
    name: 'analysis.matcher',
    type: Core.GOConfigParameterType.STRING,
    description: 'Strategia V2: ai | lexical. Default ai; ai usa GO-AI semantic-match via Bedrock diretto',
    required: false,
    defaultValue: 'ai',
    aliases: ['am'],
  },
  {
    ...
    type: Core.GOConfigParameterType.INT,
    description: 'Soglia 0..100 per considerare equivalente il semantic-match GO-AI',
    required: false,
    defaultValue: 70,
  },
  {
    name: 'go.ai.fallbackToLexical',
    type: Core.GOConfigParameterType.BOOL,
    description: 'Se GO-AI fallisce, usa il matcher lessicale invece di marcare NO_EVIDENCE',
    required: false,
    defaultValue: true,
  },
  {
    name: 'aws.region',
    type: Core.GOConfigParameterType.STRING,
    description: 'Regione AWS standard per la gestione credenziali/profili',
    required: false,
