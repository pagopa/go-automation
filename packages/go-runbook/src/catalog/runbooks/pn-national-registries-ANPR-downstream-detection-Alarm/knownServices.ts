/**
 * Known services for the pn-national-registries-ANPR-downstream-detection-Alarm runbook.
 */

/** Application service whose logs contain the ANPR downstream errors. */
...
export const DOWNSTREAM: downstream.DownstreamSelector = { kind: 'named', name: SEND_DOWNSTREAMS.ANPR };
