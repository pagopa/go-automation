...
describe('purpose outbound writer runbook', () => {
  it('is registered for every supported environment', () => {
  ...
  it('builds a SERVICE-compatible read-only runbook with the documented time window', () => {
