/**
 * Known services for the pn-national-registries-AdE-downstream-detection-Alarm runbook.
 */

/** Application service whose logs contain the AdE downstream errors. */
...
export const DOWNSTREAM: downstream.DownstreamSelector = { kind: 'named', name: SEND_DOWNSTREAMS.ADE };
