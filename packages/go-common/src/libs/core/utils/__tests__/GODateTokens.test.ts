...
describe('GODateTokens', () => {
  it('parses common formats and formats Athena date/time values', () => {
    ...
    assert.strictEqual(GODateTokens.formatAthenaDateTime(new Date('2026-05-01T03:04:05Z'), 'UTC'), '2026-05-01 03:04:05');
  });

  it('produces zero-padded range tokens', () => {
    const tokens = GODateTokens.fromRange(
      new Date('2026-05-01T03:00:00Z'),
      new Date('2026-05-02T04:00:00Z'),
      'UTC',
    );
